...
//   const animateProcess = gsap.utils.toArray(".animate-trigger");
//     animateProcess.forEach((title) => {
//         gsap.to(title, {
//           scrollTrigger: {
//             trigger: title,
//             once:true,
//             start: "top center" + #mainBox,
//             toggleClass:'trigger',
//           }
//         })
//     });   
...
function typeWriter(id, ar) {
  ...
  if (!isBackspacing) {
    ...
    if (i < aString.length) {
      ...
      if (aString.charAt(i) == "|") {
        isParagraph = true;
        eHeader.removeClass("typing");
        eParagraph.addClass("typing");
        i++;
  ...
  // If backspacing is enabled
    ...
    if (eHeader.text().length > 0 || eParagraph.text().length > 0) {
      ...
      if (eParagraph.text().length > 0) {
        ...
        eParagraph.removeClass("typing");
        eHeader.addClass("typing");
